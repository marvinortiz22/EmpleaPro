...
ALTER TABLE AUDITORIA_EMPLEADO ADD CONSTRAINT FK_EMPLEADO FOREIGN KEY (IDEMPLEADO) REFERENCES EMPLEADO (IDEMPLEADO) on delete restrict on update RESTRICT;
ALTER TABLE AUDITORIA_EMPLEADO ADD CONSTRAINT FK_USUARIOMODIFICAEMPLEADO FOREIGN KEY (USUARIOREGISTRA)
...
FOREIGN KEY (emp_idempleado) REFERENCES empleado(emp_idempleado);
