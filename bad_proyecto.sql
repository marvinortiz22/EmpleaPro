...
ADD CONSTRAINT UNIQUE_EMPLEADO_COLUMNS UNIQUE (NUMERODOC,NIT,ISSS,NUP,CORREOINSTITUCIONAL,CORREOPERSONAL);
ALTER TABLE USUARIO
ADD CONSTRAINT UNIQUE_USUARIO_COLUMNS UNIQUE (USERNAME,EMAIL);
