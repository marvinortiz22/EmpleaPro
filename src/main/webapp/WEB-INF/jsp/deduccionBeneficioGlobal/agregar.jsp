...
<title>Deducciones/beneficios</title>
...
<form:form modelAttribute="deduccionBeneficio" method="POST" action="/deduccionesBeneficiosGlobales/agregar" class="container mx-2 mt-4">
    <div class="row mb-3">
