...
public class ApiRestController {
    ...
    @Value("${spring.security.user.access_token_secret}")
    ...
    public ResponseEntity<?> registroPost(@RequestBody(required = false) Map<String, String> body,
        ...
        try{
            ...
            if(username==null||password==null||idRolStr==null){
                return ResponseEntity
                        .badRequest()
                        .body(Map.of("Error", "Debe proveer un nombre de usuario, un idrol y una contraseña"));
            }
            ...
            try{
                ...
                return ResponseEntity
                        .badRequest()
                        .body(Map.of("Error", "El idrol debe ser numérico"));
            }
            ...
            if(rolObject==null||idRol==1||idRol==3||idRol==4){//si es nulo o si es uno de los roles de la app principal
                return ResponseEntity
                        .status(HttpStatus.NOT_FOUND)
                        .body(Map.of("Error", "No se encontró el rol especificado"));
            }
